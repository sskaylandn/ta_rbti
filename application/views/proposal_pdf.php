<!DOCTYPE html>
        ...
        <br>
        <h3 class="text_content">1.4 Struktur Start Up</h3><img  src="<?php echo 'assets/files/'.$c->struktur_su?>"><br><br>
        <br>
        <h3 class="text_content">1.5 Logo Start Up</h3><img src="<?php echo 'assets/files/'.$c->logo_su?>"><br><br>
        <br>
