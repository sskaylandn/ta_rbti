<!DOCTYPE html>
        ...
        <h3 class="text_content">1.1 Nama Start Up</h3><p class="text_content2"><?php echo strtoupper ($c->nama_start_up); ?></p>
        <br>
        <h3 class="text_content">1.2 Visi Start Up</h3><p class="text_content3"><?php echo $c->visi_start_up ?></p>
        <br>
        <h3 class="text_content">1.3 Misi Start Up</h3><p class="text_content3"><?php echo $c->misi_start_up ?></p>
        <br>
        <h3 class="text_content">1.4 Struktur Start Up</h3><img src="<?php echo './assets/files/'.$c->struktur_start_up?>"><br><br>
        <br>
        <h3 class="text_content">1.5 Logo Start Up</h3><img src="<?php echo './assets/files/'.$c->logo_start_up?>"><br><br>
        <br>
        <h3 class="text_content">1.6 Tagline Start Up</h3><p class="text_content2"><?php echo strtoupper ($c->tagline_start_up) ?></p>
        <br>
        <br>
        <br>
        <br>
        ...
        <h3 class="text_content">3.3 Logo Aplikasi</h3><img src="<?php echo './assets/files/'.$c->logo_solusi?>"><br><br><br>
        <h3 class="text_content">3.4 Preview UI/UX-1</h3><img src="<?php echo './assets/files/'.$c->prev_ui1_solusi?>"><br><br><br>
        <h3 class="text_content">3.5 Preview UI/UX-2</h3><img src="<?php echo './assets/files/'.$c->prev_ui2_solusi?>"><br><br><br>
        <h3 class="text_content">3.6 Preview UI/UX-3</h3><img src="<?php echo './assets/files/'.$c->prev_ui3_solusi?>"><br><br><br>
        <h3 class="text_content">3.7 Preview UI/UX-4</h3><img src="<?php echo './assets/files/'.$c->prev_ui4_solusi?>"><br><br><br><br>
        ...
        <h3 class="text_content">4.9 Bagaimana Proses Bisnis dari aplikasi/solusi yang dibuat?</h3><p class="text_content3"><?php echo $c->proses_bisnis_pp ?></p><br>
                                <img src="<?php echo './assets/files/'.$c->proses_bisnis2_pp?>"><br><br><br>
