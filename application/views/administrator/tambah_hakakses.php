                            ...
                            <div class="card border-left-secondary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <h4 class="m-0 font-weight-bold text-dark">Tambah Hak Akses</h4>
                                        <form method="post" action="<?php echo base_url('administrator/tambah_hakakses')?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    name="hak_akses" placeholder="Hak Akses" >
